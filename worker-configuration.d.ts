/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f7a02013bfaaa5ed4a6751045491893)
...
interface __BaseEnv_Env {
	...
	WATCH_PARTY_SIGNING_SECRET: string;
	WATCH_PARTY_ENABLED: string;
	WATCH_PARTY_ROOM: DurableObjectNamespace<import("./worker/index").WatchPartyRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "WatchPartyRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_PASSWORD" | "TMDB_ACCESS_TOKEN" | "WATCH_PARTY_SIGNING_SECRET" | "WATCH_PARTY_ENABLED">> {}
}
