  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header className="max-w-2xl">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-brand-400">Saved locally</p>
        <h1 className="mt-2 text-3xl font-black tracking-tight sm:text-5xl">Your favourites</h1>
        <p className="mt-4 leading-7 text-zinc-400">Your picks stay on this device. No account is required.</p>
      </header>
